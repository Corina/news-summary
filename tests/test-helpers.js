var apiUrl = "https://content.guardianapis.com/uk-news/2017/jul/21/john-joubert-lived-in-the-same-hull-flat-as-philip-larkin"
...
var listApiUrlsFromResponse = [];
var listTitlesFromResponse = [];
var listContentsFromResponse = [];

function getApiUrlsFromResponse(apiResponse) {
  apiResponse.response.results.forEach(function(result) {
    listApiUrlsFromResponse.push(result.apiUrl);
  })
}
...
getApiUrlsFromResponse(mockGuardianApiResponse);
